...
<body>
    ...
    <a href="vue_graph_bar_line.php?type=heure"> vers graph bar line</a>

    <h1> Credit Actuel : <?=$nbcredit?></h1>
    <h1> (Hier :<?=$difcredit?>)</h1>
    <h2> Hier : <?=$dif_hier?> Watt</h2>

    <h3> Astuce du jour ! : <?=$le_tip_of_day?> </h3>
